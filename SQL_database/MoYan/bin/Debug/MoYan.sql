...
GO
PRINT N'正在删除 CHECK 约束 [dbo].[ratings] 上未命名的约束...';


GO
ALTER TABLE [dbo].[ratings] DROP CONSTRAINT [CK__ratings__tag_acc__6E01572D];
...
GO
ALTER TABLE [dbo].[ratings] DROP CONSTRAINT [CK__ratings__article__6EF57B66];
...
DECLARE tableconstraintnames CURSOR LOCAL FORWARD_ONLY
    FOR SELECT SCHEMA_NAME([schema_id]),
               ...
               0
        FROM   [sys].[objects]
        WHERE  [parent_object_id] IN (OBJECT_ID(N'dbo.ratings'))
               AND [type] IN (N'F', N'C')
